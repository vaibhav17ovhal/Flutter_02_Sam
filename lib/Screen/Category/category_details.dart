      ...
      body: ListView(
        ...
        children: [
          CarouselSlider(
            ...
            items: const [
              CategoryDetailsImage(imageUrl: "assets/images/makeup_1.png"),
              CategoryDetailsImage(imageUrl: "assets/images/makeup_2.png"),
              CategoryDetailsImage(imageUrl: "assets/images/makeup_3.png"),
            ],
          ),
          const SizedBox(
            height: 5,
...
class CategoryDetailsImage extends StatelessWidget {
  final String imageUrl;
  const CategoryDetailsImage({super.key, required this.imageUrl});
